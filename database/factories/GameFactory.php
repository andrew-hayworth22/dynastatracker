...
class GameFactory extends Factory
{
    ...
    public function definition(): array
    {
        return [
            ...
            'our_rush_att' => $this->faker->numberBetween(15, 40),
            'our_rush_yds' => $this->faker->numberBetween(50, 200),
            'our_rush_tds' => $this->faker->numberBetween(0, 3),
            'our_pass_comp' => $this->faker->numberBetween(5, 20),
            'our_pass_att' => $this->faker->numberBetween(15, 40),
            'our_pass_yds' => $this->faker->numberBetween(50, 300),
            'our_pass_tds' => $this->faker->numberBetween(0, 3),
            ...
            'our_ints' => $this->faker->numberBetween(0, 3),
            'our_punt_return_yds' => $this->faker->numberBetween(0, 100),
            'our_kick_return_yds' => $this->faker->numberBetween(0, 100),
            'our_punts' => $this->faker->numberBetween(0, 10),
            'our_punt_avg' => $this->faker->numberBetween(30, 50),
