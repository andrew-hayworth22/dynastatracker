    ...
    <div class="relative isolate overflow-hidden bg-gray-900">
        ...
        <div class="mx-auto max-w-7xl px-6 pb-24 pt-10 sm:pb-32 lg:flex lg:px-8 lg:py-40">
            <div class="mx-auto max-w-2xl flex-shrink-0 lg:mx-0 lg:max-w-xl lg:pt-8">
                <ApplicationMark class="h-11" />

                <h1 class="mt-10 text-4xl font-bold tracking-tight text-white sm:text-6xl">
                    Pursue Greatness
                </h1>
                <p class="mt-6 text-lg leading-8 text-gray-300">
                    Remember your journey to greatness. Record your stats and progression in your rise to the top by recording player statistics, game scores, and more.
                </p>
                <div class="mt-10 flex items-center gap-x-6">
                    <PrimaryButtonLink v-if="$page.props.auth.user" :href="route('dashboard')">Dashboard</PrimaryButtonLink>
                    <template v-else>
                        <PrimaryButtonLink :href="route('register')">Register</PrimaryButtonLink>
